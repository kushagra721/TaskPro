...
export default function ProjectDetailPage() {
  ...
  const doDelete = async () => {
    try {
      await dispatch(deleteProject({ orgId, projectId })).unwrap();
      navigate('/groups');
    } catch (err) {
        ...
        <>
          <div className="task-detail project-detail__card">
            <div className="task-detail__head">
              ...
              <button className="btn btn--sm hide-mobile" style={{ marginLeft: 'auto' }} onClick={() => setCreateOpen(true)}>
            ...
            {project.description && <p className="task-detail__desc">{project.description}</p>}
          </div>
          ...
          {deleteOpen && (
            <Modal title="Delete project" onClose={() => setDeleteOpen(false)}>
