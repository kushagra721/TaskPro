...
const ADMIN_NAV = [
  ...
  { to: '/platform/admin/clients', label: 'Clients', desc: 'All clients & which reseller they belong to', Icon: BuildingIcon },
];

const RESELLER_NAV = [
  { to: '/platform/reseller/clients', label: 'Clients', desc: 'Add & manage your clients', Icon: BuildingIcon },
];
